...
// =============================================================================
   ...
   *
   * @method createImg
   * @param  {String} src src routeTaken or url for image
   ...
   * can be either a single string routeTaken to a video file, or an array of string
   ...
   *
   * @method createVideo
   * @param  {String|Array} src  routeTaken to a video file, or array of paths for
   ...
   * can be either a single string routeTaken to a audio file, or an array of string
   ...
   *
   * @method createAudio
   * @param  {String|Array} src  routeTaken to an audio file, or array of paths for
   *                             supporting different browsers
   * @param  {Object} [callback] callback function to be called upon
   *                             'canplaythrough' event fire, that is, when the
   *                             browser can play the media, and estimates that
